...
class TestCuentaBancaria < Minitest::Test
    ...
    def setup
        @cuentaTest = CuentaBancaria.new(200)
        @cuentaTest.nombre_cuenta= "brayan valdebenito"
    end
    ...
    def test_retiro_disminuye_monto
        assert_equal 100, @cuentaTest.retiro(100)
    end
    ...
    def test_2_palabras_cuenta
        @cuentaTest.nombre_cuenta= "brayan valdebenito"
        arr = @cuentaTest.nombre_cuenta.split("") #validacion para saber que hay 2 palabras
        num_palabras = arr
